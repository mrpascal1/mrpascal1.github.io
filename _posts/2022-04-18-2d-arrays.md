...
*   To access <b>4</b> in the 2D array we write - <b>ratings[0][0]</b> where rating is the array and the first subscript is a row and the second subscript is a column.
*   Similarly, to access <b>12</b> in the same array we can write - ratings[1][2]
