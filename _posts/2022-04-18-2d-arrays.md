...
Lets take an example of movie rating system where you want to store movies as column and reviewers as rows:
...
*   Reviewer at 0<sup>th</sup> index has given rating <b>4</b> to the Movie at 0<sup>th</sup> index.
*   To access <b>4</b> in our 2D array we write <b>list[0][0]</b> where the first subscript is row and second subscript is column.
*   Similarly, to access <b>12</b> in our array we can write - list[1][2]
