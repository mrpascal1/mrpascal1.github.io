...
Let's take an example of a movie rating system where you want to store movies as columns and reviewers as rows:
...
*   To access <b>4</b> in the 2D array we write - <b>list[0][0]</b> where the first subscript is row and the second subscript is a column.
*   Similarly, to access <b>12</b> in the same array we can write - list[1][2]
...
<iframe
  src="https://carbon.now.sh/embed?bg=rgba%28255%2C255%2C255%2C1%29&t=lucario&wt=none&l=python&width=680&ds=true&dsyoff=20px&dsblur=68px&wc=true&wa=true&pv=56px&ph=56px&ln=false&fl=1&fm=JetBrains+Mono&fs=14px&lh=133%25&si=false&es=2x&wm=false&code=%2523%2520In%2520python%252C%2520we%2520can%2520use%2520list%2520to%2520represent%2520array.%250A%2523%2520indexing%2520starts%2520with%25200%250Aarray%2520%253D%2520%255B1%252C%25202%252C%25203%252C%25204%255D%250Aprint%28array%255B0%255D%29%2520%2523%2520Output%253A%25201%250A"
  style="width: 553px; height: 279px; border:0; transform: scale(1); overflow:hidden;"
